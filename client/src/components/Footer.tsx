    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h4 className="font-heading font-semibold text-xl mb-4">SoCal Saladmaster</h4>
            <p className="text-gray-300 mb-4">
              Authorized Saladmaster distributors bringing healthier cooking to Southern California families since 2020.
            </p>
          ...
          <div>
            <h4 className="font-heading font-semibold text-xl mb-4">Contact Information</h4>
            <ul className="space-y-2">
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:sharon@trinity4health.com" className="text-gray-300 hover:text-white transition duration-300">sharon@trinity4health.com</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:7145043014" className="text-gray-300 hover:text-white transition duration-300">(714) 504-3014</a>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            <h4 className="font-heading font-semibold text-xl mb-4">Partners</h4>
            <div className="space-y-4">
              <div>
                <a 
                  href="https://www.trinity4health.com/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition duration-300"
                >
                  <span className="block text-white font-medium mb-1">Trinity4Health</span>
                  <span className="text-sm text-gray-400">Authorized Distributor</span>
                </a>
              </div>
              <div>
                <a 
                  href="https://saladmaster.com/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition duration-300"
                >
                  <span className="block text-white font-medium mb-1">Saladmaster</span>
